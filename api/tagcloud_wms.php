...
$query1 = "SELECT distinct keyword as 'TAG', COUNT(*) as 'COUNT', type FROM keywords WHERE type='wms' GROUP BY keyword HAVING COUNT BETWEEN 0 AND 15000 ORDER BY COUNT DESC LIMIT 20";
