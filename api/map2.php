...
$q=dbq("SELECT `location`, count(location) as count FROM services WHERE `location` != '' AND `location` != 'United States' AND `version` != '' GROUP BY `location` ORDER BY `location` ASC");
