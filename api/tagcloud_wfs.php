...
$query1 = "SELECT distinct keyword as 'TAG', COUNT(*) as 'COUNT', type FROM keywords WHERE type='wfs' GROUP BY keyword HAVING COUNT BETWEEN 0 AND 1000 ORDER BY COUNT DESC LIMIT 20";
